...
#+begin_src elisp :tangle sod.el
  ...
  (setq default-directory "~/Public/projects/")
...
"[[file:~/Documents/id/sodsig-001.png]] \n"
"\n"
"Cooper Oscarfono \n" )
...
#+begin_src elisp :tangle sod.el
  ...
  (setq org-capture-templates
        `(("c" "Contact" entry (file+headline "~/Documents/contacts.org" "Contacts"), my/org-contacts-template :empty-lines 1)
          ("d" "Documentation" entry (file+headline "~/Documents/docs.org" "Documentation") "** %^{Subject}\n %^g\n %?\n %i\n Added %U")
          ("D" "Definition" entry (file+headline "~/Documents/definitions.org" "Definitions") "** %^{Term} :: %^{Definition} ")
          ("e" "Expense" entry (file+olp+datetree "~/Documents/expenses.org"), my/org-expenses-template :empty-lines 1)
          ("i" "Idea" entry (file+olp+datetree "~/Documents/ideas.org" "Ideas") "**  %?\n I had this idea on %U\n %a" :empty-lines 1)
          ("j" "Journal" entry (file+olp+datetree "~/Documents/journal.org") "*  %?\n Entered on %U\n" :empty-lines 1)
          ("l" "Lyric" entry (file+headline "~/Documents/lyrics.org" "Lyrical Ideas Capture") "** %^{working-title}\n %^{verse}\n %^{hook}\n")
          ...
          ("Q" "Quote" entry (plain "~/Documents/quotes.org"), my/org-greatquotes-template :empty-lines 1)
          ("r" "Read" entry (file+headline "~/Documents/someday.org" "Read") "** %^{title}\n %^{author}" :empty-lines 1)
          ("s" "Subject" entry (file+headline "~/Documents/someday.org" "Write"), "** %^{subject}\n" :empty-lines 1)
          ("t" "Todo" entry (file+headline "~/Documents/todo.org" "Tasks") "** TODO %?\n %i\n %a" :empty-lines 1)
          ("W" "Wishlist" plain (plain "~/Documents/someday.org" "Wishlist") "** %^{thing}" :empty-lines 1)
          ("w" "Watch" entry (file+headline "~/Documents/someday.org" "Watch") "** %^{movie title}\n %a" :empty-lines 1)))
...
(use-package ox-hugo
  :config
  (setq-local org-hugo-base-dir "~/Public/projects/oscarfono/theblacksheepblog/src/routes/blog/"))
...
#+begin_src elisp :tangle sod.el
  ...
  (setq org-ditaa-jar-path "~/Documents/contrib/scripts/ditaa0_9/ditaa0_9.jar")
...
(setq org-plantuml-jar-path
      (expand-file-name "~/Documents/contrib/scripts/plantuml-nodot.1.2023.7.jar"))
#+end_src
...
#+begin_src elisp :tangle sod.el
    ...
    (use-package whisper
     :straight (whisper
                ...
                :host github
                :repo "natrys/whisper"
                :local-repo "~/Public/projects/contrib/whisper")
